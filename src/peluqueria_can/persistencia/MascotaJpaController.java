...
public class MascotaJpaController implements Serializable {
    ...
    //Aqui creamos el administrador de entidades copiamos la linea 25 y le hacemos modificaciones
    //dentro le ponemos el nombre de la persistencia 
    //Aqui hace una nueva instancia y crea un adm de entidades teniendo en cuenta las propiedades
    //de la base dato y las clases que esten mapeadas.
     
    public MascotaJpaController() {
    emf = Persistence.createEntityManagerFactory("PeluqueriacanPU");
    }
